...
### 📱 Mobile Development
<p>
  <img src="https://skillicons.dev/icons?i=react,flutter,androidstudio,kotlin,swift" />
</p>
...
<p>
  <img src="https://skillicons.dev/icons?i=python,js,ts,java,cs,cpp,c" />
</p>
...
### 🧠 Data Science & AI/ML
<p>
  <img src="https://skillicons.dev/icons?i=python,tensorflow,pytorch,sklearn,opencv,jupyter,matlab" />
</p>
 
> Pandas · NumPy · Matplotlib · Seaborn · Scikit-learn · TensorFlow · PyTorch · Jupyter
...
| Domain | Technologies |
|--------|-------------|
| **Microcontrollers** | Arduino Uno / Mega / Nano · ESP32 · ESP8266 · STM32 |
| **Single-Board Computers** | Raspberry Pi · Raspberry Pi Pico |
| **Protocols** | UART · SPI · I2C · PWM · GPIO |
| **Robotics** | ROS (Robot Operating System) · Servo Control · Motor Drivers · PID |
| **Electronics** | Circuit Design · PCB Prototyping · Sensors · Actuators |
...
### ☁️ Cloud & Deployment
<p>
  <img src="https://skillicons.dev/icons?i=vercel,netlify,firebase,aws,azure" />
</p>
